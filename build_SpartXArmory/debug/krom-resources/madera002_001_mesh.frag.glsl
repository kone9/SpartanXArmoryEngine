...
void main()
{
    ...
    vec2 _144 = n.xy * (-11.30000019073486328125);
    n = vec3(_144.x, _144.y, n.z);
    n = normalize(TBN * n);
    ...
    float Math_Value_res = SeparateColor_Blue_res * 0.439999997615814208984375;
    float SeparateColor_Green_res = ImageTexture_001_Color_res.y;
    float Math_001_Value_res = SeparateColor_Green_res * 0.709999978542327880859375;
    ...
    {
        _207 = octahedronWrap(n.xy);
    }
    n = vec3(_207.x, _207.y, n.z);
