...
void main() {
	...
	vec3 Mapping_texread_Vector_res = ((UVMap_texread_UV_res + vec3(0.0, -1.2699999809265137, 0.0)) * vec3(2.0, 2.0, 1.0));
	...
	vec3 Mapping_001_texread_Vector_res = ((UVMap_001_texread_UV_res + vec3(0.0, -1.2699999809265137, 0.0)) * vec3(2.0, 2.0, 1.0));
	...
	float Math_001_Value_res = (SeparateColor_Green_res * 0.07000000029802322);
