...
void main() {
	...
	float Math_Value_res = (SeparateColor_Blue_res * 0.4399999976158142);
	float SeparateColor_Green_res = ImageTexture_001_Color_res.g;
	float Math_001_Value_res = (SeparateColor_Green_res * 0.7099999785423279);
